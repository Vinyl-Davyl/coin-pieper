...
// DOMPurify to sanitize HTML and prevents XSS attacks,feed DOMPurify with string full of dirty HTML and it will return a string(as used in th coin description here)
...
// since api starts with {}, its an object not array [], so useState is {}
const [coin, setCoin] = useState({})

// useParams is now used for passing in different parameters, so its shows diff data of other coins not only bitcoin, the :coinId is from the path in App.js
            ...
            <div className="content">
                ...
                <div className="info">
                    ...
                    <div className="coin-price">
                        {/* Due to error Uncaught TypeError: Cannot read properties of undefined (reading 'current_price') */}
